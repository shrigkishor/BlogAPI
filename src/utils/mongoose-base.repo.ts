...
export class MongooseBaseRepo<T> {
  ...
  bulkSave(
    ...
    options?: BulkWriteOptions & { timestamps?: boolean },
  ) {
  ...
  countDocuments(
    ...
    options?:
      | (CountOptions & Omit<MongooseQueryOptions<T>, 'lean' | 'timestamps'>)
      | null,
  ) {
  ...
  deleteMany(
    filter?: FilterQuery<T>,
    options?:
      | (DeleteOptions & Omit<MongooseQueryOptions<T>, 'lean' | 'timestamps'>)
      | null,
  ) {
